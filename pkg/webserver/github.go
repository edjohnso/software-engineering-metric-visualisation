...
type contributorsFormat []userFormat
type reposFormat []repoFormat
...
type repoFormat struct {
	ID                  int64          `json:"id,omitempty"`
	NodeID              string         `json:"node_id,omitempty"`
	Owner               userFormat     `json:"owner,omitempty"`
	Name                string         `json:"name,omitempty"`
	...
	Parent              *repoFormat     `json:"parent,omitempty"`
	Source              *repoFormat     `json:"source,omitempty"`
	TemplateRepository  *repoFormat     `json:"template_repository,omitempty"`
	...
	SecurityAndAnalysis string `json:"security_and_analysis,omitempty"`
